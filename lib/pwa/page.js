...
const createElement = (path, tagName, className) => {
  try {
    let file = fs.readFileSync(`${__dirname}/templates/page/page.tpl`, 'utf8');
...
const createAction = actionName => {
  try {
    let file = fs.readFileSync(`${__dirname}/templates/page/action.tpl`, 'utf8');
...
const createReducer = reducerName => {
  try {
    let file = fs.readFileSync(`${__dirname}/templates/page/reducer.tpl`, 'utf8');
