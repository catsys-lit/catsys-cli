...
<head>
    <meta charset="utf-8">
    <title>{{APP_CLASS}} app</title>
    <meta name="generator" content="{{APP_CLASS}} Starter Kit">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="{{APP_CLASS}} App description">
    ...
    <meta name="application-name" content="{{APP_CLASS}} App">

    <!-- Add to homescreen for Safari on iOS -->
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta name="apple-mobile-web-app-title" content="{{APP_CLASS}} App">
    ...
    <meta property="og:site_name" content="catsys-app">
...
<body>
<{{APP_TAG}}-app appTitle="{{APP_CLASS}} app"></{{APP_TAG}}-app>
<noscript>
...
<script type="module" src="src/{{APP_TAG}}-app.js"></script>
</body>
</html>
